...
public:
    ...
    QuadTree(particle_t *inp_data, int N);
	QuadTree(particle_t* inp_data, double inp_x, double inp_y, double inp_hw, double inp_hh);
    QuadTree(particle_t* inp_data, int N, double inp_x, double inp_y, double inp_hw, double inp_hh);
    QuadTree(QuadTree* inp_parent, particle_t* inp_data, int N, double inp_x, double inp_y, double inp_hw, double inp_hh);
    QuadTree(QuadTree* inp_parent, particle_t* inp_data, double inp_x, double inp_y, double inp_hw, double inp_hh);
    ~QuadTree();
    void setData(particle_t* inp_data);
    QuadTree* getParent();
...
private:
    void init(QuadTree* inp_parent, particle_t* inp_data, double inp_x, double inp_y, double inp_hw, double inp_hh);
    void fill(int N);
